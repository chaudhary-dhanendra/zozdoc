---
document_id: HES-REF-BOOK-CORE
title: Book Core Reference
version: 0.1.0
status: Draft
owner: TODO
reviewers: [TODO]
...
Provide a quick-reference guide for engineers working on book core concerns without replacing the authoritative HES volumes.
